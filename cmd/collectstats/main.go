...
func insertStats(db *pgxpool.Pool, schema string, stats *storage.Stats) error {
	...
	_, err = tx.Exec(ctx,
		...
		stats.ThrottledUserCount,
		stats.ActiveUsersCount,
		stats.ActiveUsersCountWg,
		stats.ActiveUsersCountIPSec,
		stats.TotalTraffic.Total.Rx,
		stats.TotalTraffic.Total.Tx,
		stats.TotalTrafficWg.Total.Rx,
		stats.TotalTrafficWg.Total.Tx,
		stats.TotalTrafficIPSec.Total.Rx,
		stats.TotalTrafficIPSec.Total.Tx,
