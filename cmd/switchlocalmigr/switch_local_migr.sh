...
printdef() {
        ...
        echo "  Commands:"
        echo "    switch - promote spare brigades to main"
        echo "    switch -r <reservation_id> -f <snapshot_file> [-n] [-inet <cidr>] [-enet <cidr>]"
        echo "    Options:"
        echo "       -r <reservation_id> : reservation_id"
        ...
        echo "    delete - delete spare brigades"
        echo "    delete -r <reservation_id> -f <snapshot_file>"
        echo "    Options:"
        echo "       -r <reservation_id> : reservation_id"
        echo "       -f <snapshot_file> : snapshot file (may be prepared)"
        echo "       -n : dry run"
...
EOF
                ...
                if [ -z "$new_instance" ]; then
                        echo "Brigade: $brigade_id, no brigades in reservation found"
...
EOF
                ...
                if [ -z "$old_instance" ]; then
                        echo "Brigade: $brigade_id, no spare brigades found"
