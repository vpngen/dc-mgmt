...
func (o *GetBrigadeURL) Build() (*url.URL, error) {
	...
	if brigadeID != "" {
		...
		return nil, errors.New("brigadeId is required on GetBrigadeURL")
	}
...
func (o *GetBrigadeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBrigadeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBrigadeURL")
	}
