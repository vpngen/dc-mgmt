...
// CheckOrderStatusParams contains all the bound params for the check order status operation
...
func (o *CheckOrderStatusParams) bindOrderID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
