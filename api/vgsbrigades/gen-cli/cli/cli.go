...
import (
	...
	"github.com/vpngen/dc-mgmt/api/vgsbrigades/gen-cli/client"
)
...
func makeClient(cmd *cobra.Command, _ []string) (*client.VGSBrigadeRealm, error) {
...
func makeGroupOfOperationsOperationsCmd() (*cobra.Command, error) {
	...
	sub0, err := makeOperationOperationsCheckOrderStatusCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub0)

	sub1, err := makeOperationOperationsCreateBrigadeCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub1)

	sub2, err := makeOperationOperationsDeleteBrigadeCmd()
	if err != nil {
		return nil, err
	}
	parent.AddCommand(sub2)

	sub3, err := makeOperationOperationsGetBrigadeCmd()
	if err != nil {
		return nil, err
	}
