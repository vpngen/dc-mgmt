...
//go:generate swagger generate server --target ../../gen-server --name VGSocketRealm --spec ../../swagger.yaml --principal models.Principal --exclude-main

func configureFlags(api *operations.VGSocketRealmAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.VGSocketRealmAPI) http.Handler {
