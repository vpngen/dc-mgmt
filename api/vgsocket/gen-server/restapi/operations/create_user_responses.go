...
func (o *CreateUserCreated) WithPayload(payload *models.VPNConfig) *CreateUserCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create user created response
func (o *CreateUserCreated) SetPayload(payload *models.VPNConfig) {
	o.Payload = payload
}
...
/*
CreateUserServiceUnavailable Service Temporarily Unavailable
