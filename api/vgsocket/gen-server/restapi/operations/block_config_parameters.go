...
// BlockConfigParams contains all the bound params for the block config operation
...
func (o *BlockConfigParams) bindConfigID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
