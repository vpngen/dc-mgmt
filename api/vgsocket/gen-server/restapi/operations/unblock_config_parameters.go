...
// UnblockConfigParams contains all the bound params for the unblock config operation
...
func (o *UnblockConfigParams) bindConfigID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
