...
ALTER TABLE :"schema_stats_name".brigades_stats ADD COLUMN IF NOT EXISTS update_time                    timestamp without time zone NOT NULL DEFAULT now();
ALTER TABLE :"schema_stats_name".brigades_stats ALTER COLUMN update_time DROP DEFAULT;
