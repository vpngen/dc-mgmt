...
ALTER TABLE pairs.pairs ADD COLUMN IF NOT EXISTS zone text NOT NULL DEFAULT '';
ALTER TABLE pairs.pair_orders ADD COLUMN IF NOT EXISTS zone text NOT NULL DEFAULT '';
