...
ALTER TABLE :"schema_stats_name".brigades_stats ADD COLUMN instance_id uuid DEFAULT NULL;
UPDATE :"schema_stats_name".brigades_stats SET instance_id = b.instance_id FROM :"schema_brigades_name".brigades b WHERE brigades_stats.brigade_id = b.brigade_id;
DELETE FROM :"schema_stats_name".brigades_stats WHERE instance_id IS NULL;
